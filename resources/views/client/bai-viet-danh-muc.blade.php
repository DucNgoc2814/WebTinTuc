                        ...
                        <div class="row card-body">
                            <div class="col-md-4 mb-4 mb-md-0">
                                <div class="post-slider slider-sm">
                                    <img src="{{ asset('theme/client/images/post/post-7.jpg') }}" class="card-img" alt="post-thumb"
                                        style="height:200px; object-fit: cover;">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <h3 class="h4 mb-3"><a class="post-title" href="{{ route('bai-viet-chi-tiet') }}">Advice From a Twenty
                                        Something</a></h3>
                                ...
                                <p> It’s no secret that the digital industry is booming. From exciting startups to global
                                    brands</p>
                                <a href="{{ route('bai-viet-chi-tiet') }}" class="btn btn-outline-primary">Xem thêm</a>
                            </div>
                        </div>
                    </article>
