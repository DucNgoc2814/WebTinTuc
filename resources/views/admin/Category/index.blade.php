                            ...
                            <div class="card-header border-0">
                                <div class="row g-4">
                                    <div class="col-sm-auto">
                                        <div>
                                            <a href="{{ route('admin.danh-muc.create') }}" class="btn btn-success"
                                                        ...
                                                        <thead class="gridjs-thead">
                                                            <tr class="gridjs-tr">
                                                                <th data-column-id="#" class="gridjs-th text-muted"
                                                                    ...
                                                                    <div class="gridjs-th">Mã danh mục</div>
                                                                </th>
                                                            ...
                                                            @foreach ($categories as $category)
                                                                <tr class="gridjs-tr">
                                                                    ...
                                                                    <td data-column-id="published" class="gridjs-td">
                                                                        <span>{{ $category->created_at->format('d M, Y') }}<small
                                                                                class="text-muted ms-1">{{ $category->created_at->format('H:i') }}
                                                                            </small></span>
                                                                    </td>
                                                                    <td data-column-id="action" class="gridjs-td text-center" ><span>
                                                                            <div class="dropdown"><button
                                                                                ...
                                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                                    <li><a class="dropdown-item edit-list"
                                                                                            data-edit-id="1"
                                                                                            href="{{ route('admin.danh-muc.edit', $category) }}"><i
