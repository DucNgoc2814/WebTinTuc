(itemid = 13), ClassicEditor.create(document.querySelector("#ckeditor-classic"))
  .then(function(e) {
  ...
  g &&
    ...
    s.addEventListener(
      ...
      function(e) {
        ...
        if (s.checkValidity())
          return e.preventDefault(), (c = ++itemid), (t = document.getElementById(
            "product-title-input"
          ).value), (o = m.getValue(!0)), (i = document.getElementById(
            "stocks-input"
          ).value), (n = document.getElementById("orders-input")
            .value), (r = document.getElementById("product-price-input")
            .value), (u = document.getElementById("product-img").src), "add" ==
          (d = document.getElementById("formAction").value)
            ...
            : "edit" == d
              ...
              : console.log("Form Action Not Found."), window.location.replace(
            "apps-ecommerce-products.html"
          ), !1;
        e.preventDefault(), e.stopPropagation(), s.classList.add(
          "was-validated"
        );
      },
      !1
