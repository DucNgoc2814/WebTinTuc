var productListAllData = [
    {
      id: 1,
      product: {
        img: "/theme/admin/assets/images/products/img-1.png",
    ...
    },
    {
      id: 2,
      product: {
        img: "/theme/admin/assets/images/products/img-2.png",
    ...
    },
    {
      id: 3,
      product: {
        img: "/theme/admin/assets/images/products/img-3.png",
    ...
    },
    {
      id: 4,
      product: {
        img: "/theme/admin/assets/images/products/img-4.png",
    ...
    },
    {
      id: 5,
      product: {
        img: "/theme/admin/assets/images/products/img-5.png",
    ...
    },
    {
      id: 6,
      product: {
        img: "/theme/admin/assets/images/products/img-6.png",
    ...
    },
    {
      id: 7,
      product: {
        img: "/theme/admin/assets/images/products/img-7.png",
    ...
    },
    {
      id: 8,
      product: {
        img: "/theme/admin/assets/images/products/img-8.png",
    ...
    },
    {
      id: 9,
      product: {
        img: "/theme/admin/assets/images/products/img-9.png",
    ...
    },
    {
      id: 10,
      product: {
        img: "/theme/admin/assets/images/products/img-10.png",
        ...
        },
        {
          ...
          formatter: function(e, t) {
            t = new DOMParser()
              ...
              .body.querySelector(".checkbox-product-list .form-check-input")
              .value;
            return gridjs.html(
  ...
  slider = (
    searchProductList.addEventListener("keyup", function() {
      ...
      productListAll
        .updateConfig({ data: i })
        .forceRender(), productListPublished.updateConfig({ data: e }).forceRender(), checkRemoveItem();
    }),
    Array.from(document.querySelectorAll(".filter-list a")).forEach(function(
      ...
      r.addEventListener("click", function() {
        ...
        productListAll
          .updateConfig({ data: e })
          .forceRender(), productListPublished.updateConfig({ data: i }).forceRender(), checkRemoveItem();
      });
    }),
  ...
  filterChoicesInput = (
    slider.noUiSlider.on("update", function(e, t) {
      ...
      )), (filterDataPublished = r.filter(e => parseFloat(e.price) >= a && parseFloat(e.price) <= s)), productListAll.updateConfig({ data: filterDataAll }).forceRender(), productListPublished.updateConfig({ data: filterDataPublished }).forceRender(), checkRemoveItem();
    }),
  ...
  searchBrandsOptions = (
    Array.from(
      ...
      (r.querySelector(".filter-badge").innerHTML = s), Array.from(
        r.querySelectorAll(".form-check .form-check-input")
      ).forEach(function(t) {
        var i = t.value;
        t.checked &&
          filterChoicesInput.setValue([
            i
  ...
  Array.from(e).forEach(function(e) {
    ...
    Array.from(
      ...
      e.addEventListener("click", function(e) {
        ...
        (isSelected =
          t.length), e.target.closest("tr").classList.contains("gridjs-tr-selected"), (document.getElementById("select-content").innerHTML = isSelected), (document.getElementById("selection-element").style.display = 0 < isSelected ? "block" : "none");
      });
    ...
    .addEventListener("show.bs.modal", function(e) {
      (isSelected = 0), document.getElementById("delete-product").addEventListener("click", function() {
        Array.from(
          ...
          .click(), document.getElementById("selection-element") && (document.getElementById("selection-element").style.display = "none"), (checkboxes.checked = !1);
      });
    });
}
  ...
  Array.from(document.querySelectorAll(".edit-list")).forEach(function(t) {
    t.addEventListener("click", function(e) {
      (i = t.getAttribute(
        ...
        return e.id == i &&
          sessionStorage.setItem("editInputValue", JSON.stringify(e)), e;
      }));
    });
  });
}
